...
define("NL_PROVIDERS",      " (UPPER(provider) = 'CANALDIGITAAL' OR UPPER(provider) = 'CANAALDIGITAAL' OR UPPER(provider) = 'M7 GROUP') ");
...
class channelGroupingManager{
    ...
    protected function __construct(){
        ...
        $debuglogfile = $this->config->getValue("userdata")."logs/groupinglog.txt";
